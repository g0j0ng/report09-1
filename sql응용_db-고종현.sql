...
-- insert into 정보 values('영화코드','배우주민번호','장르코드','감독등록번호')
...
select distinct 장르.장르명 장르, count(*) 제작편수
...
-- update 정보 set 장르코드='000111' where 장르명= 'Romantic comedy';
-- update 장르 set 장르코드='000111' where 장르명 = 'Romantic comedy';

-- update 정보 join 장르 on 정보.장르코드=장르.장르코드 
-- set 장르코드='000111', 장르명='로맨틱 코미디' where 장르명= 'Romantic comedy';
-- update 정보 join 장르 on 정보.장르코드=장르.장르코드 
-- set 장르코드='000111', 장르명='로맨틱 코미디' where 장르명= 'Romantic comedy';

-- update 장르 join 정보 on 장르.장르코드=정보.장르코드 
-- set 장르코드='000111', 장르명='로맨틱 코미디'  where 장르코드 in(
-- 	select 장르명 from 장르 where 장르명= 'Romantic comedy'
-- );
